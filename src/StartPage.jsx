  ...
  return (
    <>
      ...
      <div className="info-mssg">
        ...
        This Website Is Created By Jaya Surya. This Website Is Just Created For
        Testing Purpose And Just For My Satisfaction. This Website Uses Backend:
      ...
      <div className="warn-mssg" id="warn-mssg">
        ...
        No Supplementery Results Are Updated. May The Results In This Website Is
        Not Accurate and Not Up To Date
      </div>
    </>
  );
}
